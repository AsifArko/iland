        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            ...
            <p className="text-xs leading-relaxed text-muted-foreground/80 sm:text-sm max-w-lg font-light tracking-wide">
              Discover all the powerful features that make iLand the ultimate
              platform for creating, managing, and delivering online courses
              with cutting-edge technology and seamless user experience.
            </p>
